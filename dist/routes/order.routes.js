...
router.post("/", auth_middleware_1.authenticate, (0, role_middleware_1.authorize)([user_model_1.UserRole.ATTENDANT, user_model_1.UserRole.MANAGER, user_model_1.UserRole.MASTER]), order_controller_1.default.createOrder);
router.get("/", auth_middleware_1.authenticate, (0, role_middleware_1.authorize)([user_model_1.UserRole.ATTENDANT, user_model_1.UserRole.MANAGER, user_model_1.UserRole.MASTER]), order_controller_1.default.listOrders);
// Rotas para cozinha
